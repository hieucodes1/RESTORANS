...
namespace RESTORANS.Areas.Admin.Controllers
{
    ...
    public class MenufooterController : Controller
    {
        ...
        public MenufooterController(Datacontext context)
        {
            _context = context;
        }
        ...
        {
            var mnList = _context.Menus.Where(m => m.Position == 2).OrderBy(m => m.MenuID).ToList();
            return View(mnList);
        }
        ...
        {
            var mnList = (from m in _context.Menus.Where(m=>m.Position == 2)
